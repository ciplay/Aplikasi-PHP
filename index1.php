	...
	<div class="container">
		...
		if(isset($_GET['pesan'])){
			...
			if($_GET['pesan'] == "gagal2"){
      		...
      		if($_GET['pesan'] == "gagal3"){
        		echo"<div style='margin-bottom:-55px' align ='center' class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-warning-sign'></span>   Nama Sudah Terdaftar!!!</div>";
      		}			
		}
		?>
